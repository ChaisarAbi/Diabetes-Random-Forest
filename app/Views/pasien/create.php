                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="nama" name="nama" 
                                               value="<?= old('nama') ?>" required placeholder="Masukkan nama pasien">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="umur" name="umur" 
                                               value="<?= old('umur') ?>" required min="1" max="120" placeholder="Tahun">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" step="0.1" class="form-control" id="berat" name="berat" 
                                               value="<?= old('berat') ?>" required min="1" max="300" placeholder="Contoh: 65.5">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" step="0.1" class="form-control" id="tinggi" name="tinggi" 
                                               value="<?= old('tinggi') ?>" required min="30" max="300" placeholder="Contoh: 170.5">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="alamat" name="alamat" rows="2" 
                                                  placeholder="Masukkan alamat pasien (opsional)"><?= old('alamat') ?></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
